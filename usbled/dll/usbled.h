...
/* at Sat Mar 16 13:25:11 2013
 */
/* Compiler settings for usbled.idl:
...
EXTERN_C const IID IID_ILed;
    ...
    MIDL_INTERFACE("B21CEEEA-8E6C-4948-808D-36947C6FCF9B")
...
#define ILed_Command(This,Value)	\
    ( (This)->lpVtbl -> Command(This,Value) ) 

#define ILed_Connect(This)	\
...
#ifndef __usbledLib_LIBRARY_DEFINED__
#define __usbledLib_LIBRARY_DEFINED__

/* library usbledLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_usbledLib;

EXTERN_C const CLSID CLSID_Led;

#ifdef __cplusplus

class DECLSPEC_UUID("8F279928-297A-466A-B511-D00116713995")
Led;
#endif
#endif /* __usbledLib_LIBRARY_DEFINED__ */
